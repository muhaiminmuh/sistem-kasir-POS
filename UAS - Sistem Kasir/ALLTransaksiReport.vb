...
Public Class ALLTransaksiReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UAS___Sistem_Kasir.ALLTransaksiReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedALLTransaksiReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ALLTransaksiReport = New ALLTransaksiReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
