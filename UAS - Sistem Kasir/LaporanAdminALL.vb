...
Public Class LaporanAdminALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UAS___Sistem_Kasir.LaporanAdminALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanAdminALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanAdminALL = New LaporanAdminALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
