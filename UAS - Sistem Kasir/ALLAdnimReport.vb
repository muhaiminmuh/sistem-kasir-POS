...
Public Class ALLAdnimReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UAS___Sistem_Kasir.ALLAdnimReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedALLAdnimReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ALLAdnimReport = New ALLAdnimReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
